...
#Germany and Canada version are after this function
generate_model_str_columbia <- function(df, df_prepped, item_type, f) { # f = num factors
...
# The Canada and Germany version from Levante-pilots
